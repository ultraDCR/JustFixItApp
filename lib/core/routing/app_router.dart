  ...
  static Route onGenerateRoute(RouteSettings routeSettings) {
    switch (routeSettings.name) {
      ...
      case providerRequests:
        var arg = routeSettings.arguments as Uri?;
        return MaterialPageRoute(
            builder: (context) => ProviderRequestPage(),
      ...
      case editProfile:
        ...
        return MaterialPageRoute(
            builder: (context) => BlocProvider(
                  create: (context) => EditProfileCubit(authRepository: context.read<AuthRepository>()),
      ...
      case createService:
        var arg = routeSettings.arguments as Uri?;
        return MaterialPageRoute(
            builder: (context) => ProviderCreateServicePage(),
